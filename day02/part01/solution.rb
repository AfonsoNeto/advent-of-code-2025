...
def invalid_id?(id)
  ...
  # An invalid ID is a sequence of number repeated twice, so it can only be invalid for even num of characters
  return false if individual_characters.size.odd?
